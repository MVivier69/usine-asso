...
window.USINE_CONFIG = {
  ...
  asso: {
    ...
    paves: [
      ...
      { titre: "Site association l'Usine", image: "", pleineLargeur: true,
  ...
  galerie: {
    ...
    photos: [
      ...
      { image: "images/galerie/photo-2.jpg", legende: "Visite famille Roux", lien: "https://www.lusine-belleville.net/photos/visite-famille-roux" },
